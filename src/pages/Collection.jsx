...
// ترجمه فارسی → انگلیسی برای API
const CATEGORY_MAP = {
  "همه"      : null,        // ارسال نمی‌شه
  "مردانه"   : "men",
  "زنانه"    : "women",
  "کفش"      : "shoes",
  "اکسسوری" : "accessories",
        ...
        <div className="space-y-3">
              ...
              {ALL_COLORS.map((color) => (
                <div key={color} onClick={() => toggleColor(color)}
                  className={`w-7 h-7 rounded-full cursor-pointer border-2 shadow transition ${
                    selectedColors.includes(color) ? "border-pink-600 scale-110" : "border-gray-400"
                  }`}
          ...
          <details className="group border rounded-xl p-3 bg-white shadow-md">
            ...
            <div className="mt-5" dir="ltr">
              <PriceRangeSlider min={0} max={1000000} onChange={(range) => setPriceRange(range)} />
